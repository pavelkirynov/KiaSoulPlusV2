    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text(
                    text = "Розділ щойно з'явився, і поки в ньому лише те, що застосунок уже " +
                        "знав про машину. Наступні системи шукаються на вкладці «Експерименти»: " +
                        "там видно всі кадри шини, а різниця між двома знімками показує, який із " +
                        "них відповідає за що.",
                    style = MaterialTheme.typography.bodySmall,
                )
            }
        }
