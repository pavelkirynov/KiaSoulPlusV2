...
object RangeEstimator {
     ...
     *
     * Крок десять кілометрів на годину, від сорока до ста тридцяти. Було чотири
     * швидкості, і саме на цій таблиці стало видно, чого їй бракує: між 90 і 110
     * витрата росте на чверть, а вибрати щось посередині нема з чого. Опір повітря
     * росте як квадрат швидкості, тож цікаве саме те, що між круглими числами.
     */
    val SCENARIO_SPEEDS_KMH = listOf(
