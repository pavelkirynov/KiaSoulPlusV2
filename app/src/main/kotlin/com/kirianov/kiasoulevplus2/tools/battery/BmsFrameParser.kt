// ====================================================================================
// РОЗБІР СИРИХ ВІДПОВІДЕЙ ELM327 (BmsFrameParser)
//
// Єдине місце, де текст від адаптера перетворюється на байти. Раніше та сама логіка
// була скопійована в BatteryDecoder і CellDecoder окремо — тепер обидва беруть її звідси.
//
// Чиста функція без Android і без Bluetooth: покривається звичайними JVM-тестами.
// ====================================================================================
