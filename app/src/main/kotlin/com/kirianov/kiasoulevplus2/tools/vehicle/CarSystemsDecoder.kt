...
object CarSystemsDecoder {
     ...
     * рівно те саме, що в кадрі 4F0, до десятої.
     *
     * Біти 6-7 байта 2 звідси прибрані навмисно. Ми вважали їх запалюванням і
     * записували в журнал значенням пари; за одну поїздку вони перебрали 0, 1, 2,
     * 3, тобто це лічильник кадру. Питання закрите, а лічильник нам ні до чого.
     */
    private fun drive(b: List<Int>): DriveState? {
        if (b.size < 8) return null
        return DriveState(known = true, speedKmh = b[1] / 2.0)
    }
