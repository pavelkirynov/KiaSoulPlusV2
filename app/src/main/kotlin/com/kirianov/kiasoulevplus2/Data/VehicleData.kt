 ...
 *
 * Два джерела навмисно нарізно. [reported] приходить кадром 581, тобто від
 * БОРТОВОГО ЗАРЯДНОГО: він каже правду про змінний струм і мовчить усю швидку
 * зарядку, бо на постійному струмі станція живить батарею повз нього. [sensed] —
 * це наш власний висновок зі струму батареї, який іде з кадру 21 01 і на швидкій
 * зарядці єдиний і лишається.
 *
 * Тримати їх в одному полі не можна: кадр 581 приходить регулярно й затирав би
 * висновок, а висновок затирав би кадр.
 */
data class ChargingState(
    ...
    val isCharging: Boolean get() = reported || sensed
}
