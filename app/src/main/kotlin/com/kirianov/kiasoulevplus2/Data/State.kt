...
data class State(
    ...
    /**
     * Прохання «Налаштування» з картки зарядки: перейти в розділ налаштувань і
     * прокрутити прямо до ціни зарядки, а не змушувати шукати її в списку.
     *
     * Чисто навігаційний прапорець — жоден блок його не веде, лише Interface сам
     * із собою через хаб: AppNavigation перемикає розділ, SettingsScreen прокручує
     * й гасить прапорець. Тут, а не пряме посилання між екранами, бо блоки
     * інтерфейсу нічого одне про одного не знають.
     */
    val navigateToSettingsChargingRequest: Boolean = false,
