...
## Що рахується інтегралом, а що лічильником

У застосунку два джерела енергії, і кожне вибране за роздільністю, а не за звичкою.

**Витрата й рекуперація — інтеграл миттєвої потужності.** Крок опитування BMS
близько 0.98 с (цикл 800 мс плюс вікно монітора кожен четвертий раз), тобто на
п'ятихвилинному відрізку ~308 зразків. Помилка від рідкої виборки випадкова, а не
систематична, і падає як 1/√N.

**Зарядка — дельта пожиттєвого лічильника.** Причина в кроці лічильника 0.1 кВт·год:

| Що міряємо | Величина | Помилка лічильника |
|---|---|---|
| Відрізок 5 хв, пробки 20 км/год | 0.30 кВт·год | ±47 % |
| Відрізок 5 хв, місто 35 км/год | 0.44 кВт·год | ±32 % |
| Відрізок 5 хв, трасса 90 км/год | 1.43 кВт·год | ±10 % |
| Година трасси | 17.1 кВт·год | ±0.8 % |
| Зарядка на 30 кВт·год | 30 кВт·год | ±0.5 % |

На відрізку лічильник непридатний, на зарядці — найточніший з доступного. Плюс
лічильник не залежить ні від частоти опитування, ні від того, чи був телефон
під'єднаний: заряджання найчастіше й проходить без телефона, і різниця з останнім
побаченим показом це враховує.

**Слабке місце інтеграла** — зсув нуля датчика струму: він не усереднюється, а
накопичується з часом (0.3 А ≈ 0.23 кВт·год за дві години). Перевіряється
порівнянням суми відрізків із дельтою лічильника за поїздку; поки такий замір не
зроблено, поправка не вводиться.
