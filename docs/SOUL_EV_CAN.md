...
## Широкомовні кадри, які ми ще не читаємо

| кадр | що | як рахувати |
|---|---|---|
| `4B0` | швидкості **чотирьох коліс** окремо | по 16 біт LE ÷ 30 → км/год |
| `433` | стоянковий гальмо | байт 2, біт 3 |
| `050` | світло (байт 1, маска 0x03), склоочисники й покажчики (байт 2) | біти |
| `567` | годинник авто | байти 1, 2, 3 — години, хвилини, секунди |
