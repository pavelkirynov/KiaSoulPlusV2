...
**Що робить застосунок:** читає `567` і порівнює з годинником телефона. Це не
виправляє час, але прибирає найгіршу частину — незнання, чому Android Auto
раптом перестав під'єднуватись.
